@{
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-ItGlueDeviceConfig to 1.0.0.20 (Added support for API-supported filters. See https://api.itglue.com/developer/#configurations-index).'
