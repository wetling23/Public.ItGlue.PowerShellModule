@{
    ...
    FunctionsToExport = 'Get-ItGlueContact', 'Get-ItGlueDeviceConfig', 'Get-ItGlueFlexibleAssetField',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Get-ItGlueDeviceConfig to 1.0.0.21 (Updated parameter name and added alias.). Added Get-ItGlueContact.'
