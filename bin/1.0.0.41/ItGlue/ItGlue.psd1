@{
    ...
    'Out-ItGlueFlexibleAsset', 'Get-ItGlueOrganization', 'Out-PsLogging-Function',
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ReleaseNotes = 'Updated Remove-ItGlueFlexibleAssetInstance to 1.0.0.15 (added check for "closed connection" response).'
